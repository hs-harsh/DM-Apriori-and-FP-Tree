# -*- coding: utf-8 -*-
"""FP_Tree_Modified.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11vkzZXgoIHerJNGKiYk2lC3kLfeKulHK
"""
...
"Tree object which keeps track of what itemsets have already been output."
...
while(minsup<0.92):
  ...
  fis = [itemset for itemset in maximal_frequent_itemsets(itemsets, supcount)]
...
print(result)
print(count)
file_name="/content/drive/My Drive/Colab Notebooks/DM Assignment/forests_analysis_M.csv"
...
print(result)
print(count)
file_name="/content/drive/My Drive/Colab Notebooks/DM Assignment/bog_analysis_M.csv"
result.to_csv(file_name, sep='\t')